...
func main() {
	...
	fmt.Sprintf("SNS = ", V_SNS)
	SNS := check_resposta(V_SNS)
	fmt.Sprintf("SNS = ", SNS)
	...
	w.WriteString(fmt.Sprintf("<td> <div class=\"cdn\"><a href=\"%s\" target=\"_blank\"><img src=\"%s\"><br>APIGateway</a></div></td>", L_API, IMG_API))
    	w.WriteString("</tr>")
    	w.WriteString("<tr>")
