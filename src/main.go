...
func main() {
	...
	w.WriteString("<html><head><title>Cloud Wizard</title></head>")
   	...
   	w.WriteString("a.ativo:link, a.ativo:visited, a.ativo:hover, a.ativo:active {color: black;}")
   	w.WriteString("a.inativo a.inativo:link, a.inativo:visited, a.inativo:hover, a.inativo:active {color: #E8DAEF;}")
   	w.WriteString("</style>")
   	w.WriteString("</head>")
	//Body
